...
const incomingEvents = ["needHeatMap", 'needGeneratePicture', 'needPictureNNPPlot', 'needInitialPlot', "receivedHeatMap", 'receivedInitialPlot', 'receivedPictureHeatmapPlot'];
